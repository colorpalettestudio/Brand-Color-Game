        ...
        {gameState === "playing" && (
          <div className="w-full h-full flex flex-col items-center justify-center min-h-0">
              ...
              <motion.div 
                  ...
                  className="flex flex-col items-center mb-2 md:mb-6 xl:mb-12 shrink-0"
              >
                  <span className="text-[8px] md:text-xs xl:text-sm font-bold uppercase tracking-widest text-muted-foreground mb-0.5 md:mb-1 xl:mb-2">Current Score</span>
                  <div className="text-3xl md:text-6xl xl:text-8xl font-display font-bold text-foreground tabular-nums leading-none tracking-tight">
